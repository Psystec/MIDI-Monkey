...
namespace MIDI_Monkey.Helpers
{
    public static class ToolTipLoader
    {
        private static readonly Dictionary<string, string> ToolTips = new Dictionary<string, string>
        {
            ...
            [ControlNames.GroupBoxMIDIChannels] = "Enable or disable specific MIDI channels for playback.\nThis allows you to filter out unwanted instrument tracks from the MIDI file.",
            [ControlNames.PictureBoxDiscord] = "Join the MIDI Monkey Discord community!\nWhere you can get support, share feedback, and connect with other users.",
            [ControlNames.PictureBoxSignalApp] = "Fully Open-sourced Online MIDI Editor. Start creating music without installing anything."
    ...
    public static class ControlNames
    {
        ...
        public const string GroupBoxMIDIChannels = "groupBoxMIDIChannels";
        public const string PictureBoxDiscord = "pictureBoxDiscord";
        public const string PictureBoxSignalApp = "pictureBoxSignalApp";
    }
}
